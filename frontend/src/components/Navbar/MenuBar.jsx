...
const MenuBar = () => {
  ...
  if(user.avatar!=undefined){
    ...
    return (
      ...
      >
        <Link className='timeline' to="/timeline" style={{ textDecoration: 'none' }}>
        <MenuItem onClick={()=>{console.log("timeline")}}>

TimeLine
        
        </MenuItem>
        </Link>
                <Link className='link' to="/newPost" style={{ textDecoration: 'none' }}>
